...
noremap <PLUG>(tab_diff_start)
			\ :<C-u>call s:Tab.tabcopy()<CR>:windo diffthis<CR>:windo call tab_diff#common#map_diff()<CR>|"

noremap <PLUG>(tab_diff_end)
			\ :<C-u>diffoff!<CR>:windo call tab_diff#common#map_diff_reset()<CR>:tabc<CR>|"

noremap <PLUG>(tab_diff_orig)
			\ :<C-u>call s:Tab.tabcopy()<CR>:only<CR>:DiffOrig<CR>:windo call tab_diff#common#map_diff()<CR>|"

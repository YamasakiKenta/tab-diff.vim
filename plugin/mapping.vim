...
noremap <PLUG>(tab_diff_start)
			\ :<C-u>call <SID>copy_wins()<CR>:windo diffthis<CR>:windo call tab_diff#common#map_diff()<CR>|"

noremap <PLUG>(tab_diff_end)
			\ :<C-u>diffoff!<CR>:windo call tab_diff#common#map_diff_reset()<CR>:tabc<CR>|"

noremap <PLUG>(tab_diff_orig)
			\ :<C-u>call <SID>copy_wins()<CR>:only<CR>:DiffOrig<CR>:windo call tab_diff#common#map_diff()<CR>|"
